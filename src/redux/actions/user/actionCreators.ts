...
import { IDailyRateRequest, IDailyRateResponse, IUserRegisterData } from 'API';
...
export const postUserDailyRateSucceededAction = createAction<{ request: IDailyRateRequest, userId: string }, 'POST_USER_DAILY_RATE_SUCCEEDED'>(POST_USER_DAILY_RATE_SUCCEEDED);
