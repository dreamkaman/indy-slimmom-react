...
const RadioButton = ({ register = null, rules = null }) => {
    return <>
        ...
        <ul className={s.radioBtnWrapper}>
            <li>
                <input type="radio" id="group1" value="1" defaultChecked {...register("bloodType", rules)} />
                <label htmlFor="group1">1</label>
            </li>
            <li>
                <input type="radio" id="group2" value="2" {...register("bloodType", rules)} />
                <label htmlFor="group2">2</label>
            </li>
            <li>
                <input type="radio" id="group3" value="3" {...register("bloodType", rules)} />
                <label htmlFor="group3">3</label>
            </li>
            <li>
                <input type="radio" id="group4" value="4" {...register("bloodType", rules)} />
